Contributing to antimony Core
============================

The antimony Core project operates an open contributor model where anyone is
...
The following applies to code changes to the antimony Core project, and is not to be
confused with overall antimony Network Protocol consensus changes.

Whether a pull request is merged into antimony Core rests with the project merge
...
Patches that change antimony consensus rules are considerably more involved than
...
Where a patch set proposes to change the antimony consensus, it must have been
...
The project leader is the release manager for each antimony Core release.
