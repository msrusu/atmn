...
This mechanism has been integrated into Bitcore-Node-antimony which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/antimony-crypto/insight-api-antimony#web-socket-api](https://github.com/antimony-crypto/insight-api-antimony#web-socket-api)
* API: [https://github.com/antimony-crypto/insight-api-antimony#swifttx-transactions](https://github.com/antimony-crypto/insight-api-antimony#swifttx-transactions)
...
By default, the antimony Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the antimony Core daemon:
