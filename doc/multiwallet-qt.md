...
In order to support loading of multiple wallets in antimony-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is antimony.cpp.
...
Changes to antimony.cpp
----------------------
antimony.cpp is the entry point into antimony-qt, and as such, will require some minor modifications to provide hooks for
